...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "4. Fill all answers.",
      "5. The browser authorizes the exact answer payload with the access token.",
      "6. Submit gaslessly through the relay endpoint without sending the raw token.",
      "7. The contract verifies the candidate, authorization digest, budget, and exam status before accepting the submission.",
    ],
  },
  {
    title: "How gas works",
  ...
  },
  {
    ...
    body: [
      ...
      "The browser uses the token locally to authorize the exact answers, timestamp, exam ID, and candidate ID.",
      "The relay endpoint receives the authorization digest, not the readable token.",
  ...
  },
  {
    ...
    body: [
      ...
      "A submission can be graded once, then finalized once from the graded state.",
